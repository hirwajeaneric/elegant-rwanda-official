...
export const metadata = buildMetadata({
  ...
  description:
    "Book premium cab services in Rwanda with Elegant Travel & Tours. Professional drivers, 24/7 availability, and custom routes for seamless transfers across the country.",
  path: "cab-booking",
  keywords:
