...
export const services: Service[] = [
  {
    ...
    active: true,
    order: 1,
    metaTitle: 'Unique Tours Rwanda - Custom Itineraries | Elegant Travel and Tours',
  ...
  },
  {
    ...
    active: true,
    order: 2,
    metaTitle: 'Cab Booking Rwanda - Premium Transfer Services | Elegant Travel and Tours',
  ...
  },
  {
    ...
    active: true,
    order: 3,
    metaTitle: 'Car Rental Rwanda - Self-Drive & Chauffeur Services | Elegant Travel and Tours',
  ...
  },
  {
    ...
    active: true,
    order: 4,
    metaTitle: 'Air Travel Assistance Rwanda - Visa & Airport Services | Elegant Travel and Tours',
  ...
  },
  {
    ...
    active: true,
    order: 5,
    metaTitle: 'Upcoming Events Rwanda - Group Tours & Cultural Events | Elegant Travel and Tours',
  ...
  },
  {
    ...
    active: true,
    order: 6,
    metaTitle: 'Custom Travel Packages Rwanda - Personalized Itineraries | Elegant Travel and Tours',
